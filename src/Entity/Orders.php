...
class Orders
{
    ...
    #[ORM\ManyToOne(targetEntity: CouponsName::class, inversedBy: 'orders')]
    private $coupons;
    ...
    public function getCoupons(): ?CouponsName
    {
        return $this->coupons;
    }

    public function setCoupons(?CouponsName $coupons): self
    {
