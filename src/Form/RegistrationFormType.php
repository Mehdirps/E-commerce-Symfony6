    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('RGPDConsent', CheckboxType::class, [
                ...
                ], 'label' => 'En m\'inscrivant à ce site, j\'accèpte de partager mes données personnelles avec le site pour le traitement de mes demandes et la création de mon compte'
            ])
